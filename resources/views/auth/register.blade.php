...
@include('partial.errors')
            <form action="{{ route('register.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group has-feedback">
                    <input type="text" class="form-control" placeholder="شماره همراه" name='mobile' id='mobile'>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="checkbox icheck">
                            <label>
                                <input type="checkbox" name="terms" id="terms"> من <a href="#">قوانین و شرایط</a> را قبول میکنم.
                            </label>
                        </div>
                    </div>
                    <!-- /.col -->
            ...
            <a href="{{route('register.login.index')}}" class="text-center">من قبلا ثبت نام کرده ام</a>
        </div>
        <!-- /.form-box -->
    </div>
    <!-- /.register-box -->
